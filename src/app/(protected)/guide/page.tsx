...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    description: 'חשב גודל פוזיציה, סיכון יומי ו-Take Profit אוטומטית',
    href: '/risk-calculator',
    features: [
      'חישוב גודל פוזיציה מקסימלי לפי סיכון מההון',
      'סיכון מקסימלי ליום ולעסקה בדולרים',
      'יעדי Take Profit אוטומטיים ל-1:1, 1:2, 1:3',
    ],
  },
  {
    id: 'fundamental-scanner',
    icon: '🔬',
    title: 'סורק פונדמנטלי',
    description: 'מצא מניות עם צמיחה חזקה בדוחות',
    href: '/fundamental-scanner',
    features: [
      'סורק את כל מניות S&P 500 לפי צמיחת EPS והכנסות',
      'מזהה סקטורים חמים, IPO חדש ודוחות קרובים',
      'ציון AI 0-100 עם חיפוש בגוגל ל-20 המניות המובילות',
    ],
  },
  {
    id: 'swing-patterns',
    icon: '📐',
    title: 'תבניות סווינג',
    description: 'למד לזהות תבניות גרף קלאסיות',
    href: '/swing-patterns',
    features: [
      '14 תבניות מפתח: פריצה, טריז, ראש וכתפיים ועוד',
      'הסבר לכל תבנית: מתי להיכנס, סטופ ויעד',
      'איורים ויזואליים עם EMA8 ו-SMA200',
    ],
  },
  {
    id: 'swing-scanner',
    icon: '📡',
    title: 'סורק סווינג',
    description: 'סרוק מניות לפי RSI, נפח ו-SMA200',
    href: '/swing-scanner',
    features: [
      'סינון דינמי לפי שינוי %, נפח, שווי שוק ו-RSI',
      'תבניות סריקה מוכנות (Presets)',
      'שמירת מניות למעקב ישירות מהתוצאות',
    ],
  },
  {
    ...
    description: 'בדף כל מניה — ניתוח מעמיק עם AI',
    features: [
      '10 מדדים מרכזיים עם ✅/⚠️/❌: הכנסות, רווח, שולי רווח ועוד',
      'טבלת 4 הרבעונים האחרונים עם EPS מול ציפיות',
      'תחזית AI עם חיפוש בגוגל: מתחזקת/נחלשת + ציון 0-100',
    ],
  },
]
