// Scan universe for the swing scanner — the full S&P 500 constituent list
// (scraped from https://en.wikipedia.org/wiki/List_of_S%26P_500_companies)
// plus popular Israeli (TASE) tickers. Dotted share classes (e.g. BRK.B) are
// normalized to Yahoo Finance's dash notation (BRK-B).
